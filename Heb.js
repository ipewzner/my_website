let heb = {
    "strings": {
        ...
        "page_1_h2": "שלום",
        "page_1_p": "שמי " + "<b>ישעיהו פבזנר</b>"+",  אני בוגר תואר ראשון במדעי המחשב מ "+"<b>המרכז האקדמי לב</b>"+".",
...
let en = {
    "strings": {
        ...
        "page_1_p2": "In <b>embedded</b> development, I have experience with <b>Linux, Raspberry Pi, Arduino, ESP32, STM32</b>, and more.",
        "page_1_p2_2": "In <b>web</b> development, I utilize <b>JavaScript</b> and <b>React</b> to create dynamic front-end experiences, and <b>Node.js</b> and <b>MongoDB</b> for efficient database management.",
